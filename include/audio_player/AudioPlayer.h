// Audio Player
// NO IDEA YET...All i know is it Uses PortAudio
// Have to somehow make a real-time audio generator/player
// Idea -> Create a baseline "Generator" which can be called effectively to generate the Audio buffer based on the "current output buffer"
